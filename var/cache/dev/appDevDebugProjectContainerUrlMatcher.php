    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/guests')) {
            ...
            if (0 === strpos($pathinfo, '/guests/modify') && preg_match('#^/guests/modify/(?P<id_client>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'client_modify')), array (  '_controller' => 'AppBundle\\Controller\\ClientsController::showDetails',));
            }

            // clients_new
            if ($pathinfo === '/guests/new') {
                return array (  '_controller' => 'AppBundle\\Controller\\ClientsController::showNew',  '_route' => 'clients_new',);
            }
